...
LineSepWhois 1
MTSVersion 1.1
Name 'Elite' w/fully colored nicks
ParenText (<text>)
...
TextChan !Script %:echo  $+ %::cnick $+ $etheme.npad(%::nick) $+ ]: %::text %:comments
TextChanSelf !Script %:echo $iif($_optn(0,23), $+ %::cnick $+ $etheme.npad(%::me)) $+ ]: %::text %:comments
