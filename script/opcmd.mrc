...
dialog tempban {
  ...
  text "&Reason for tempban?", 203, 7 5 165 10
  combo 1, 5 15 165 80, drop result edit

  text "&Tempban for:", 2, 7 30 35 10, right
  edit "", 3, 44 28 20 11
  text "seconds", 4, 65 30 100 10
...
dialog strictm {
  ...
  text "&View settings for:", 1, 3 5 65 10, right
  combo 2, 70 3 90 50, drop sort
  button "&Add...", 3, 162 3 25 10
  button "&Remove", 4, 190 3 30 10

  box "Modes:", 5, 5 20 215 49
  text "&Always enforced:", 6, 10 29 66 10, right
  text "&Always set when opped:", 7, 10 42 66 10, right
  text "&Set if none set:", 8, 10 55 66 10, right
  edit "", 9, 77 27 60 11, autohs
  edit "", 10, 77 40 60 11, autohs
  edit "", 11, 77 53 60 11, autohs
  button "Use current", 109, 150 28 55 10, disable
  button "Use current", 110, 150 41 55 10, disable
  button "Use current", 111, 150 54 55 10, disable

  box "&Topics:", 12, 5 75 215 24
  combo 13, 10 83 66 50, drop
  combo 14, 77 83 137 50, drop edit

  edit "", 15, 1 1 1 1, hide autohs

  button "Close", 100, 130 107 40 12, ok default
  button "&Help", 101, 175 107 40 12, disable
}
...
dialog recond {
  ...
  box "&Kick reason:", 3, 5 55 170 27
  combo 4, 10 65 159 75, drop edit

  box "Action:", 5, 5 86 170 49
  button "&Kick", 6, 10 97 25 12, default
  check "&Kick clones also", 9, 40 99 129 8
  button "&Ban:", 7, 10 115 25 12
  combo 8, 40 116 129 75, drop edit

  text "1) Select a recent offender from the list.", 201, 180 15 55 50
  text "2) Optionally change the kick reason.", 202, 180 65 55 24
  text "3) Select Kick or Ban to punish.", 203, 180 95 55 35

  button "Cancel", 101, 207 122 25 12, cancel
