...
dialog addons {
  ...
  box "Installed addons", 11, 6 6 253 92
  list 1, 13 18 153 85, sort
  button "&Information...", 101, 173 18 80 14, default
  button "&Uninstall", 102, 173 38 80 14
  button "&Configure...", 103, 173 57 80 14
  button "&Help on addon...", 104, 173 77 80 14

  box "More addons", 12, 6 104 253 92
  list 2, 13 116 153 85, sort
  button "&Information...", 201, 173 116 80 14
  button "&Install", 205, 173 136 80 14
  button "&Delete...", 206, 173 156 80 14

  button "&Close", 21, 73 202 53 14, cancel
  button "&Help", 22, 140 202 53 14, disable
}
...
dialog addoninfo {
  ...
  text "Addon:", 2, 2 6 53 9, right
  text "", 12, 60 6 200 9
  text "Version:", 3, 2 15 53 9, right
  text "", 13, 60 15 200 9
  text "For PnP:", 4, 2 25 53 9, right
  text "", 14, 60 25 200 9
  text "Author:", 5, 2 35 53 9, right
  text "", 15, 60 35 200 9
  text "E-Mail:", 6, 2 45 53 9, right
  link "", 16, 60 45 200 9
  text "Homepage:", 7, 2 55 53 9, right
  link "", 17, 60 55 200 9
  text "Info:", 8, 2 67 53 9, right
  edit "", 18, 60 65 200 61, multi read return vsbar
  text "Addon file(s):", 9, 2 130 53 9, right
  text "(Double-click a filename to view it)", 10, 2 143 53 29, right disable
  list 19, 60 128 200 61

  button "Close", 1, 60 187 66 14, cancel default
}
